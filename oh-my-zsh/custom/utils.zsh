...
function e() {
    local file
    IFS=$'\n' file=$(fd --type file --follow --hidden . $HOME | fzf --layout=reverse --query="$1" --preview 'bat --style=numbers --color=always --theme=gruvbox-dark {}')
...
function v() {
    ...
    IFS=$'\n' file=$(fd --type file --follow --hidden --no-ignore-vcs | fzf --layout=reverse --query="$1" --preview 'bat --style=numbers --color=always --theme=gruvbox-dark {}')
...
function vv() {
    ...
    if in_git_repo; then
        ...
        IFS=$'\n' file=$(fd --type file --follow --hidden --no-ignore-vcs --base-directory ${base_directory} | fzf --layout=reverse --query="$1" --preview 'bat --style=numbers --color=always --theme=gruvbox-dark {}')
